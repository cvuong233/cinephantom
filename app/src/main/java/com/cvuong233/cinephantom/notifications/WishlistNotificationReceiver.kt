...
class WishlistNotificationReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val notification = NotificationCompat.Builder(context, WishlistNotificationScheduler.CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_notification_wishlist)
